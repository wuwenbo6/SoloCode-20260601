...
export declare class XRCPUDepthInformation {
    [P_DEPTH_INFO]: {
        data: ArrayBuffer;
        width: number;
        height: number;
    ...
    constructor(data: ArrayBuffer, width: number, height: number, normDepthBufferFromNormView: XRRigidTransform, rawValueToMeters: number, dataFormat: XRDepthDataFormat);
...
//# sourceMappingURL=XRDepthInformation.d.ts.map